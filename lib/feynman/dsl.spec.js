  ...
  describe('interactions', () => {
    ...
    context('an interaction with no parameters', () => {
      ...
      it("throws a helpful error when you try to use an interaction that doesn't exist", () => {
        assert.throws(
          () => Interactions.Click,
          `The action 'Click' is not defined.
 Here are the ones that are already defined:
  ...
  * LogIn`
    ...
    context('an interaction with a parameter', () => {
      ...
      it("throws a helpful error when you try to use a factory method that doesn't exist", () => {
        assert.throws(() => Interactions.Click.link, /not defined/i)
      })
    })
    ...
    context('giving feedback about missing interactions', () => {
