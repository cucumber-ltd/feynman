...
const Script = () => {
  const script = {} // TODO something fancy with a Proxy?
  const id = 'ClickOn.button'
  script.button = (...args) => ({ id, args })
  script.button.id = 'ClickOn.button'
  return script
}
